...
func TestOKWithScaleUp(t *testing.T) {
	...
	nptProv := NewMockMaxNodeProvisionTimeProvider(time.Minute)
...
func TestNodeWithoutNodeGroupDontCrash(t *testing.T) {
	...
	fakeClient := &fake.Clientset{}
	fakeLogRecorder, _ := utils.NewStatusMapRecorder(fakeClient, "kube-system", kube_record.NewFakeRecorder(5), false, "my-cool-configmap")
	nptProv := NewMockMaxNodeProvisionTimeProvider(15 * time.Minute)
	clusterstate := NewClusterStateRegistry(provider, ClusterStateRegistryConfig{
		MaxTotalUnreadyPercentage: 10,
		OkTotalUnreadyCount:       1,
	}, fakeLogRecorder, newBackoff(), nptProv)
...
func TestExpiredScaleUp(t *testing.T) {
	...
	fakeClient := &fake.Clientset{}
	fakeLogRecorder, _ := utils.NewStatusMapRecorder(fakeClient, "kube-system", kube_record.NewFakeRecorder(5), false, "my-cool-configmap")
	nptProv := NewMockMaxNodeProvisionTimeProvider(2 * time.Minute)
	clusterstate := NewClusterStateRegistry(provider, ClusterStateRegistryConfig{
		MaxTotalUnreadyPercentage: 10,
		OkTotalUnreadyCount:       1,
	}, fakeLogRecorder, newBackoff(), nptProv)
...
func TestUnregisteredNodes(t *testing.T) {
	...
	fakeClient := &fake.Clientset{}
	fakeLogRecorder, _ := utils.NewStatusMapRecorder(fakeClient, "kube-system", kube_record.NewFakeRecorder(5), false, "my-cool-configmap")
	nptProv := NewMockMaxNodeProvisionTimeProvider(10 * time.Second)
	clusterstate := NewClusterStateRegistry(provider, ClusterStateRegistryConfig{
		MaxTotalUnreadyPercentage: 10,
		OkTotalUnreadyCount:       1,
	}, fakeLogRecorder, newBackoff(), nptProv)
...
func TestScaleUpBackoff(t *testing.T) {
	...
	fakeClient := &fake.Clientset{}
	fakeLogRecorder, _ := utils.NewStatusMapRecorder(fakeClient, "kube-system", kube_record.NewFakeRecorder(5), false, "my-cool-configmap")
	nptProv := NewMockMaxNodeProvisionTimeProvider(120 * time.Second)
	clusterstate := NewClusterStateRegistry(provider, ClusterStateRegistryConfig{
		MaxTotalUnreadyPercentage: 10,
		OkTotalUnreadyCount:       1,
	}, fakeLogRecorder, newBackoff(), nptProv)
...
func TestScaleUpFailures(t *testing.T) {
	...
	fakeLogRecorder, _ := utils.NewStatusMapRecorder(fakeClient, "kube-system", kube_record.NewFakeRecorder(5), false, "my-cool-configmap")
	nptProv := NewMockMaxNodeProvisionTimeProvider(15 * time.Minute)
	clusterstate := NewClusterStateRegistry(provider, ClusterStateRegistryConfig{}, fakeLogRecorder, newBackoff(), nptProv)
